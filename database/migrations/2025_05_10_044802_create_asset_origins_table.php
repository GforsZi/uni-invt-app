...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('asset_origins', function (Blueprint $table) {
            ...
            $table->foreign('ast_orgn_created_by')->references('id')->on('users')->onDelete('cascade');
            $table->foreign('ast_orgn_updated_by')->references('id')->on('users')->onDelete('cascade');
            $table->foreign('ast_orgn_deleted_by')->references('id')->on('users')->onDelete('cascade');
