...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('roles', function (Blueprint $table) {
            ...
            $table->foreign('rl_created_by')->references('id')->on('users')->onDelete('cascade');
            $table->foreign('rl_updated_by')->references('id')->on('users')->onDelete('cascade');
            $table->foreign('rl_deleted_by')->references('id')->on('users')->onDelete('cascade');
