...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('category_assets', function (Blueprint $table) {
            ...
            $table->foreign('ctgy_ast_created_by')->references('id')->on('users')->onDelete('cascade');
            $table->foreign('ctgy_ast_updated_by')->references('id')->on('users')->onDelete('cascade');
            $table->foreign('ctgy_ast_deleted_by')->references('id')->on('users')->onDelete('cascade');
