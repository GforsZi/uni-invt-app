      ...
      <form action="/role/add" method="post">
        ...
        <div class="card-body">
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" name="rl_name" class="form-control @error('rl_name') is-invalid @enderror" id="inputEmail3">
            </div>
          </div>
          <div class="row mb-3">
            <label for="inputPassword3" class="col-sm-2 col-form-label">Description</label>
            <div class="col-sm-10">
              <textarea name="rl_description" class="form-control @error('rl_description') is-invalid @enderror"></textarea>
            </div>
          </div>
          </fieldset>
          <div class="row mb-3">
